...
const PRESIDENT = {
  ...
  role: 'President, New Horizon Educational Institutions',
  image: '/president.png',
  heading: 'Empowering Students to Lead and Create',
  desc: [
    ...
    <section id="team" className=" py-16">
      <div className="container-wide">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Leadership</p>
          ...
          <div className="grid lg:grid-cols-[35%_65%]" style={{ minHeight: '400px' }}>
            ...
            >
              <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-3 py-1.5 mb-5 w-fit animate-[slideUpFade_0.45s_ease-out_both]">
                ...
                <span className="text-white/60 text-xs font-medium tracking-wide">Message</span>
              </div>
              ...
              <div className="animate-[slideUpFade_0.45s_ease-out_both]" style={{ animationDelay: '0.12s' }}>
                ...
                {leader.roles.map(r => (
                  <p key={r} className="text-gold-400 text-sm font-semibold">{r}</p>
                ))}
              </div>

              <div
                className="mt-6 bg-white/5 border border-white/10 rounded-2xl p-5 space-y-3 text-white/75 text-sm sm:text-base leading-relaxed animate-[slideUpFade_0.45s_ease-out_both]"
              ...
              {leader.quote && (
                ...
                >
                  <p className="text-white/55 italic text-sm leading-relaxed">"{leader.quote}"</p>
                  <p className="text-gold-500 text-xs mt-1.5">— {leader.name}</p>
                </div>
              )}
            </div>
            ...
            return (
              ...
              >
                ...
                <div className="text-center">
                  <p className={`text-xs font-bold leading-snug transition-colors ${isActive ? 'text-navy-900' : 'text-slate-500 group-hover:text-navy-700'}`}>
                    {l.name}
                  </p>
                  <p className={`text-xs mt-0.5 leading-snug transition-colors ${isActive ? 'text-gold-600' : 'text-slate-400 group-hover:text-slate-600'}`}>
                    {l.role}
                  </p>
                </div>
              </button>
          ...
          <div className="grid lg:grid-cols-[38%_62%] gap-12 items-start">
            ...
            <div className="lg:pt-4">
              <div className="flex items-center gap-3 mb-6">
                ...
                <p className="font-bold text-navy-900 text-base uppercase tracking-wide">President's Message</p>
              </div>
              <h2 className="font-display font-bold text-navy-950 text-2xl sm:text-3xl leading-snug mb-6">
                {PRESIDENT.heading}
              </h2>
              ...
              <div className="mt-5">
                ...
                <p className="text-gold-600 font-semibold text-sm mt-1">{PRESIDENT.role}</p>
              </div>
            </div>
            </AnimateIn>
            ...
            {VALUES.map(v => {
              ...
              return (
                <div key={v.title} className="bg-slate-50 border border-slate-100 rounded-2xl p-6 hover:shadow-md transition-all hover:-translate-y-1">
                  ...
                  <h3 className="font-bold text-navy-900 text-sm mb-2">{v.title}</h3>
